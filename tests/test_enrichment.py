"""
Automated Pytest for salazar-corcoran-obese-crcl Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    SalazarcorcoranobesecrclEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = SalazarcorcoranobesecrclEnrichmentSuite()
